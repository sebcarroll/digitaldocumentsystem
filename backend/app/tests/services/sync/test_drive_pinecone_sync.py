...
def test_sync_folder(drive_pinecone_sync, mock_drive_service):
    ...
    mock_drive_service.list_folder_contents.return_value = [
        ...
        {'id': 'subfolder', 'mimeType': 'application/vnd.google-apps.folder'},
        {'id': 'file2', 'mimeType': 'text/plain'}
    ]

    with patch.object(drive_pinecone_sync, 'sync_file') as mock_sync_file, \
         patch.object(drive_pinecone_sync, 'sync_folder') as mock_sync_folder:
    ...
    mock_sync_folder.assert_called_once_with('subfolder')
