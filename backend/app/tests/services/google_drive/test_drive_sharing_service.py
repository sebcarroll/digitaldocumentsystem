...
from services.google_drive.drive_sharing_service import DriveSharingService
...
def drive_sharing_service(mock_session):
    with patch('services.google_drive.drive_sharing_service.DriveCore') as MockDriveCore:
