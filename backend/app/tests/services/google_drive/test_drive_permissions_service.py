...
def test_update_permission_success(drive_permissions_service):
    ...
    result = drive_permissions_service.update_permission('file123', 'perm123', 'writer')
...
def test_remove_permission_success(drive_permissions_service):
    ...
    result = drive_permissions_service.remove_permission('file123', 'perm123')
    
    assert result['message'] == "Permission removed successfully"
    drive_permissions_service.drive_core.drive_service.permissions().delete.assert_called_once()
